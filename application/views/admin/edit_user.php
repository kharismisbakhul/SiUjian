                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/edituser/') . $id_temp; ?>" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="password" class="form-control" id="passwordadd" name="passwordadd" placeholder="Password" value="<?= $detailUser['password']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="password" class="form-control" id="password2" name="password2" placeholder="Password" value="<?= $detailUser['password']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
