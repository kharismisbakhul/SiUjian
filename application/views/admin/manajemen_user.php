        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="d-none d-lg-block col-md-6 mb-4">
                        <div class="shadow mb-1">
                            <a class="d-block card-header py-3 bg-blue text-decoration-none">
                                <div class="d-sm-flex align-items-center justify-content-between">
                                    <h6 class=" m-0 font-weight-bold clr-white">Action Manajemen User</h6>
                                </div>
                            </a>
                            <div class="collapse show" id="collapseCardExample">
                                <div class="col-lg-12 py-4 px-3 mb-4">
                                    <button type="button" class="btn btn-primary modal-import-data" data-toggle="modal" data-target="#ModalImportData" data-id="">
                                        <i class="fas fa-fw fa-upload pr-2"></i>Import Data User
                                    </button>
                                    <button type="button" class="btn btn-success modal-template-data ml-3" data-toggle="modal" data-target="#ModalTemplateData" data-id="">
                                        <i class="fas fa-fw fa-download pr-2"></i>Download Template Excel
                                    </button>
                                </div>
                            </div>
                        </div>
