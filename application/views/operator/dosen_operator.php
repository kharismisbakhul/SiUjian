                           ...
                           <?php $i = 1;
                            foreach ($dosen as $d) : ?>
                             ...
                             <td class="text-center">
                               <a href="<?= base_url('operator/dosen/profile/') . $d['nip']; ?>" class="badge btn-info btn-icon-split btn-sm">
                                 <span class="icon text-white-50">
                                   <i class="fas fa-eye"></i>
                                 </span>
                                 <span class="text">Profil</span>
                               </a>
                               <a href="<?= base_url('operator/dosen/ujian/') . $d['nip']; ?>" class="badge btn-ujian btn-icon-split btn-sm">
                                 <span class="icon text-white-50">
                                   <i class="fas fa-paste"></i>
                                 </span>
                                 <span class="text clr-white">Ujian</span>
                               </a>
                               <a href="<?= base_url('operator/dosen/bimbingan/') . $d['nip']; ?>" class="badge btn-bimbingan btn-icon-split btn-sm">
                                 <span class="icon text-white-50">
