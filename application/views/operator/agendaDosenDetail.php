...
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="row">
        <h1 class="h3 mb-4 text-gray-800 col-lg-12"><?= $title;  ?> (Operator)</h1>
    </div>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row mt-2 mb-1 m-0">
                        ...
                        <button class="col-lg-2 btn btn-primary" data-toggle="modal" data-target="#ModalAgendaDosenOperator">
                            <span class="icon text-white-50">
                                <i class="fas fa-plus"></i>
                            </span>
                            <span class="text">Add Lecture Agenda</span>
                        </button>
                    </div>
...
<!-- Modal Agenda -->
<div class="modal fade" id="ModalAgendaDosenOperator" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Agenda Dosen via Operator</h5>
