               ...
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     ...
                     <div class="h4 mb-0 font-weight-bold text-gray-800 mt-3">Ujian Proposal</div>
                   </div>
                   <div class="col-auto">
               ...
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     ...
                     <div class="h4 mb-0 font-weight-bold text-gray-800 mt-3">14 Juli 2019</div>
                   </div>
                   <div class="col-auto">
               ...
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     ...
                     <div class="dosen-penguji mb-0 font-weight-bold text-gray-800">Denny Sagita</div>
                     <div class="dosen-penguji mb-0 font-weight-bold text-gray-800">Bayu Priambada</div>
                   </div>
                   <div class="col-auto">
