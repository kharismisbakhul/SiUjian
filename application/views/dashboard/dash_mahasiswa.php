...
<div class="container-fluid">
  ...
  <div class="row">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col ml-auto">
              <div class="h5 mb-0 font-weight-bold text-gray-800">Selamat Datang di SiUjian, <span id="user_name" class="text-gray-900 font-weight-bolder"><?= $user['nama'] ?></span></div>
                <div class="text-s font-weight-normal text-gray-800 mt-2 text-justify" style="max-width: 90%">
                  SiUjian merupakan sistem dengan berbasiskan website. Untuk mendapatkan pengalaman pengguna yang lebih, pengguna sebaiknya menggunakan browser Chrome dan Firefox. 
                  Untuk info lebih lanjut dapat datang ke ruang Pengelolaan Sistem Informasi dan Kehumasan (PSIK) FEB.
              </div>
            </div>
    ...
    <div class="col-xl-4 col-md-6 mb-4 dftr">
    ...
    <div class="col-lg-8 box">
      <div class="card shadow border-bottom-warning" style="max-height: 80%">
        ...
        <div class="card-body bClip">
          <i class="fas fa-clipboard-list text-gray-200 rotate-15 clip"></i>
          <div class="col-lg-12">
