    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="d-none d-lg-block col-md-10 mb-4 mt-3">
                    <div class="shadow mb-1">
                        <a href="#collapseCardExample" class="d-block card-header py-3 bg-blue text-decoration-none" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h6 class=" m-0 font-weight-bold clr-white">Tentang Laporan Status Mahasiswa</h6> <i><i class="fas fa-chevron-down clr-white"></i></i>
                            </div>
                        </a>
                        <div class="collapse show" id="collapseCardExample">
                            <div class="card-body pb-4 text-justify font-weight-normal clr-black">
                                <span class="font-weight-bold">Laporan Status Mahasiswa</span> merupakan list atau daftar seluruh mahasiswa S2 dan S3 yang masih / sedang menjalankan studi di Fakultas Ekonomi dan Bisnis (FEB) 
                                beserta tahap ujian terakhir telah dilakukan oleh mahasiswa tersebut.
