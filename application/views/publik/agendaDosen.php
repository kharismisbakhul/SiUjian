                        ...
                        <div class="col-lg-12 col-md-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 bg-blue">
                                    <h6 class="m-0 font-weight-bold text-capitalize clr-white">Lecturer List</h6>
                                </div>
                                <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    foreach ($dosen as $d) : ?>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?= base_url('agendaDosen/agenda/') . $d['nip']; ?>" class="btn btn-info btn-icon-split btn-sm">
