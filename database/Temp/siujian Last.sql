...
--
-- Host: localhost
-- Generation Time: Sep 20, 2019 at 02:16 PM
...
CREATE TABLE `agendaDosen` (
  ...
  `waktuSelesai` time NOT NULL DEFAULT '00:00:00',
  `durasi` time NOT NULL DEFAULT '00:00:00',
  `hariAgenda` varchar(5) DEFAULT NULL,
  `kategoriAgenda` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `agendaDosen`
--

INSERT INTO `agendaDosen` (`id_agenda`, `nip_dosen`, `nama_agenda`, `tanggalMulai`, `waktuMulai`, `tanggalSelesai`, `waktuSelesai`, `durasi`, `hariAgenda`, `kategoriAgenda`) VALUES
(13, '3000', 'Agenda 2 hari', '2019-09-02', '10:00:00', '2019-09-04', '12:00:00', '00:00:00', NULL, 2),
(14, '3000', 'Agenda sehari', '2019-09-14', '10:00:00', '0000-00-00', '12:00:00', '00:00:00', NULL, 1),
(15, '3000', 'Bimbingan', '2019-09-01', '10:00:00', '2019-09-30', '00:00:00', '00:00:00', 'TU', 3),
(16, '3000', 'Agenda Coba 1 Hari', '2019-09-16', '10:00:00', '0000-00-00', '11:00:00', '00:00:00', NULL, 1),
(17, '3000', 'Agenda Repetitif', '2019-09-01', '09:00:00', '2019-11-30', '10:00:00', '00:00:00', 'WE', 3),
(18, '3000', 'Agenda Dari Operator', '2019-09-08', '14:30:00', '0000-00-00', '16:00:00', '00:00:00', NULL, 1),
(19, '3000', 'Agenda dari Operator', '2019-09-05', '10:30:00', '2019-09-07', '22:00:00', '00:00:00', NULL, 2);
...
(16, 'Agenda Dosen', 'mahasiswa/agendaDosen', 'fas fa-fw fa-user', '1', 5),
(17, 'Agenda Dosen', 'dosen/agendaDosen', 'fas fa-fw fa-user', '1', 4),
(18, 'Lecture Agenda', 'operator/agendaDosen', 'fas fa-fw fa-user', '1', 2);
