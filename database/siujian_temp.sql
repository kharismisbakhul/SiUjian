...
INSERT INTO `dosen` (`nip`, `nama`, `posisi`, `statusAktif`) VALUES
...
INSERT INTO `mahasiswa` (`nim`, `nama`, `noTest`, `prodikode`, `password`, `angkatan`, `jalur`, `konsentrasi`, `alamat`, `noTelp`, `asalStudi`, `judulTugasAkhir`, `tglMasuk`, `tglMulaiTA`, `statusKelulusan`, `statusWisuda`, `statusTOEFL`, `statusTPA`) VALUES
('165150201111001', 'Adi Saputra', 'AAA', 7, '123', 2016, 'snmptn', '', 'Jl. Kucing', '0888', 'SMAN 1 Malang', 'How To Be Mature to Economics', '2019-07-01', '2019-07-10', 1, 1, 1, 1),
('165150201111231', 'Aditya Yusril Fikri', '1234', 4, '$2y$10$HgGBhJC.JrNcCcVPJ1UZQOgHmvwD3x8W9aRqNLqvzVuOy/qK5oEFa', 2017, 'snmptn', 'rpl', 'jln. malang aja', '0987654322', 'UB', 'pengaruh senyawa x terhadap senyawa y menggunakan metode z', '2017-06-14', '2019-07-01', 0, 0, 0, 0);
...
INSERT INTO `user` (`id`, `user_profile_kode`, `username`, `password`, `is_active`, `nama`, `date_created`) VALUES
(1, 4, '165150201111230', '$2y$10$HgGBhJC.JrNcCcVPJ1UZQOgHmvwD3x8W9aRqNLqvzVuOy/qK5oEFa', 0, 'ini dosen', 1),
...
(5, 1, '165150201111234', '$2y$10$HgGBhJC.JrNcCcVPJ1UZQOgHmvwD3x8W9aRqNLqvzVuOy/qK5oEFa', 1, 'Admin', 1),
(6, 4, '165150201111300', '$2y$10$HgGBhJC.JrNcCcVPJ1UZQOgHmvwD3x8W9aRqNLqvzVuOy/qK5oEFa', 1, 'Fajar Pradana', 1),
(7, 1, 'Jhonny', '$2y$10$HPagxDqmW6Q0SCt3YQa.eeS4ChgmAdlTjH3sguWMBXBJHo0cwPo2S', 1, 'Misbakhul', 0),
(11, 4, 'Johny', '$2y$10$EqVGPcMqA.ckB/BJzfsLRO5XGjcUP/sgZ4dH1uDSOQ8TF86reV5ka', 0, 'Johny', 0);
